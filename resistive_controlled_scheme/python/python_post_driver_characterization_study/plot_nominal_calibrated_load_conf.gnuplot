...
## second file
####################
input_file_1 = 'exported_results_nominal/full_range_r_read/1r_calibrated_load_resistances.data'
input_file_2 = 'exported_results_nominal/full_range_r_read/1r_read_r_for_calibrated_load_resistances.data'
input_file_3 = 'exported_results_nominal/full_range_r_read/1t1r_calibrated_load_resistances.data'
input_file_4 = 'exported_results_nominal/full_range_r_read/1t1r_read_r_for_calibrated_load_resistances.data'
output_file='exported_gnuplot/'
set term svg noenhanced size 1400,1800 font 'Times,25' # fname 'Times' #fsize 35
set output output_file."lin_calibrated_loads.svg"
